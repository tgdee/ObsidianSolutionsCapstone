...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   <div>
       <asp:Literal ID="ltError" Text="" runat="server"></asp:Literal>
            <asp:GridView ID="gvCorporateSuccess" runat="server" AutoGenerateColumns="False" DataKeyNames="CorporateSponsor" DataSourceID="CorporateSuccess">
                <Columns>
       ...
       <asp:SqlDataSource ID="CorporateSuccess" runat="server" ConnectionString="<%$ ConnectionStrings:Lab3ConnectionString %>" 
